                    ...
                    <div class="object__desc">
                        ...
                        <div class="object__desc-name">
                            ...
                            <button id="addToFavoriteBtn"
                                    class="
                                    button-favorite
                                    ${isFaved ? "button-favorite--active" : ""}
                                    "
                                    >
...
export function toggleFavoriteButton(isFaved) {
    const btn = document.querySelector("#addToFavoriteBtn");
    if (isFaved) {
        btn.classList.add("button-favorite--active");
        btn.querySelector("span").textContent = "В избранном";
    } else {
        btn.classList.remove("button-favorite--active");
